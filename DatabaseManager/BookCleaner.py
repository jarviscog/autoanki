...
def __clean_pages(self):
    for page in self.pages:
        clean_page(self.directory + page)


def __compact_pages(self):
    """
...
# TODO Clean all functions above this comment
...
class BookCleaner:
    ...
    1 - Scrub garbage characters and compact pages

    2 - Grab pinyin for pages
    """
